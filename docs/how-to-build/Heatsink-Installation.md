...
1. Using a tape, mark a line at 400mm from each side of the aluminum heatsink.
...
8. Remove the angle profile and with a larger drill bit (e.g., 5mm) make the holes bigenough to insert the screw.
