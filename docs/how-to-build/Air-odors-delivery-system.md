...
NOTE: This map shows the connections needed to run a 1-odor conditioning experment. If you wish to run 2-odor conditioning, you need to add one more valve on each side (to switch between either of the odors). The numbered list below describes how they air and odors are processed, while the assembly of key parts will be discussed in later sections.
