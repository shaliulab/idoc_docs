...
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- | ---- | --------------------- | -------------- | ---------------------------------------- |
| 20-way  ribbon cable terminated either  end with IDC connector. | IDOC  setup to the front powering platform inside the enclosure. | 25 cm                                    | 1    | 20-way IDC  connector | 20-way IDC     | **<img src="assets/Images/Double-IDC-connectors-cable.PNG" alt="relative" style="width: 80%;" />** |
| 20-way  ribbon cable one end open while the other end is terminated with IDC connector | Enclosure  back powering platform outside of the enclosure to the Arduino control board. | 100-150  cm  Depend  on the distance between the enclosure and the Arduino control unit | 1    | IDC  connector        | IDC  connector | <img src="assets/Images/Double-IDC-connectors-cable.PNG" alt="relative" style="width: 80%;" /> |
| 20-way  ribbon cable one end open while the other end is terminated with IDC connector | LED  panel and enclosure powering platform.  Each  pair of the open end is connected to a LED string. | 100cm                                    | 8    | IDC  connector        | Open  end      | <img src="assets/Images/open-ended-IDC-ribbon-cable.PNG" alt="relative" style="width: 100%;" /> |
| 20-way  ribbon cable terminated either  end with IDC connector. | Enclosure  wiring platform and connection of LED strings in series connection. | 50cm                                     | 10   | IDC  connector        | IDC  connector | <img src="assets/Images/Double-IDC-connectors-cable.PNG" alt="relative" style="width: 80%;" /> |
| 20-way  ribbon cable terminated either  end with IDC connector. | These cables mate with the 20way PCB headers  of the LED driver | 100-150cm                                | 5    | IDC  connector        | IDC  connector | <img src="assets/Images/Double-IDC-connectors-cable.PNG" alt="relative" style="width: 80%;" /> |
| 20-way  ribbon cable one end open while the other end is terminated with IDC connector | Connect  the Arduino control board to the screw terminal block of the solenoid valves. | 100-150  mm  Depend  on the distance between the solenoids and the control unit | 1    | IDC  connector        | Open  end      | <img src="assets/Images/open-ended-IDC-ribbon-cable.PNG" alt="relative" style="width: 100%;" /> |
...
<img src="assets/Images/Ribbon-cable-mapping.PNG" alt="relative" style="width: 30%;" />
